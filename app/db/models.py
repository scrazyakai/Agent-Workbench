...
class Run(Base):
    ...
    execution_mode: Mapped[str] = mapped_column(String(24), default="model", server_default="model")
    config_snapshot: Mapped[dict] = mapped_column(JSON, default=dict, server_default="{}")
